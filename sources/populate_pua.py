...
unusedValues = (
    ...
    0xe04c, 0xe086, 0xe087, 0xe088,
    -1  # added to prevent out-of-bounds error
)
unusedValueInd = 0
rangeA = (0xe000, 0xe050)   # Ranges do not include the second number.
rangeB = (0xe080, 0xe09a)
...
names = (
    ...
    "xy_questiondown", "xy_apos.isol", "xy_apos.init", "xy_apos.medi",
...
if current_font.italicangle != 0:
    ...
    print("This is not an italic font. Fishhook E not added")
